...
* die Instanztypen c4, m4 und r4 werden in diesem Release nicht mit neuen Cloud Volumes ONTAP-Systemen unterstützt.
+
Wir weisen jedoch für diese Instanztypen immer noch Festplattenbeschränkungen auf, da Sie ein System auf diese Version aktualisieren können, wenn Sie auf einem dieser Instanztypen ausgeführt werden.
...
[cols="26,26,48"]
|===
| Lizenztyp | Instanzfamilie | Begrenzung von Storage-VMs 


| *Freemium* | c5, m5 und r5  a| 
* 24 Storage VMs insgesamt ^1,2^




| *Kapazitätsbasierte PAYGO oder BYOL* ^3^ | c5, m5 und r5  a| 
* 24 Storage VMs insgesamt ^1,2^




.2+| *Node-basiertes PAYGO* | c4, m4 und r4  a| 
...
.2+| *Node-basiertes BYOL* ^4^ | c4, m4 und r4  a| 
* 1 Storage-VM zur Bereitstellung von Daten
* 1 Storage VM für Disaster Recovery
